  ...
  return (
    <div className={s.field}>
      ...
      <span className={s.hint}>
        ...
        {' '}
        {purpose === 'voice'
          ? '云端网关(硅基流动 / OpenAI 兼容那一类)**有自己的 /models**,先点「获取模型」再勾,协议选「OpenAI 兼容语音」;'
            + '本机 TTS 服务(IndexTTS 那类)通常**没有 /models** —— 那时用左边的「手动添加」:'
            + '把服务名当模型 id 填进来,协议选「同步 · IndexTTS 形状」,再勾准它能不能克隆音色、收不收参考音频。'
